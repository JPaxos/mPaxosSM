#!/bin/bash
#SBATCH -w pmem-[2-6],hpc-9 -t 10:0:0 --wait-all-nodes=1
...
do
    ...
    do
        ...
        do
				...
				# 16 entries: 10240 12288 14336 16384 18432 20480 24576 28672 32768 36864 40960 49152 57344 65536 73728 81920
            for reqsize in `seq 10240 2048 20479` `seq 20480 4096 40959` `seq 40960 8192 81920`
            do
                printf "%120s\n" "=" | tr ' ' '='
