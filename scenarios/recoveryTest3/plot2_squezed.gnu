set output "plot2_squezed.pdf"
set term pdfcairo size 8.8cm,4cm font ",10"
...
plot 'results/fc_ifUp1_0.05' using 1:($2*8/1e9) title 'Follower' with lines
...
plot 'results/fc_ifUp2_0.05' using 1:($2*8/1e9) title 'Crashing follower' with lines
