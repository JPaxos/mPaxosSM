...
set ylabel "Requests per second [kRPS]" offset 1
set xlabel ' ' offset 0, 0.25
set lmargin at screen MARGIN
set rmargin at screen MARGIN+WIDTH
plot 'results/fc_rps0_0.05' using 1:($2/1e3) title '3 replicas' with lines
...
set ytics format ""
plot '../recoveryTest5/results/fc_rps0_0.05' using 1:($2/1e3) title '5 replicas' with lines
