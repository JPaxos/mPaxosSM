...
set output "${TARGET}rps3.svg";
set title "${TITLE}, ${R3}, smoothed 0.05s, RPS" offset 0,-1 noenhanced
plot '${PREFIX}rps3_0.05' with filledcurves x1 fs solid 0.1 notitle , '' with lines lt 1 lw 2 notitle;

set output "${TARGET}rps4.svg";
set title "${TITLE}, ${R4}, smoothed 0.05s, RPS" offset 0,-1 noenhanced
plot '${PREFIX}rps4_0.05' with filledcurves x1 fs solid 0.1 notitle , '' with lines lt 1 lw 2 notitle;
...
set output "${TARGET}dps3.svg";
set title "${TITLE}, ${R3}, smoothed 0.05s, DPS" offset 0,-1 noenhanced
plot '${PREFIX}dps3_0.05' with filledcurves x1 fs solid 0.1 notitle , '' with lines lt 1 lw 2 notitle;

set output "${TARGET}dps4.svg";
set title "${TITLE}, ${R4}, smoothed 0.05s, DPS" offset 0,-1 noenhanced
plot '${PREFIX}dps4_0.05' with filledcurves x1 fs solid 0.1 notitle , '' with lines lt 1 lw 2 notitle;
...
set output "${TARGET}maxCpu3.svg";
set title "${TITLE}, ${R3}, smoothed 0.05s, max CPU [%]" offset 0,-1 noenhanced
plot '${PREFIX}maxCpu3_0.05' with filledcurves x1 fs solid 0.1 notitle , '' with lines lt 1 lw 2 notitle;

set output "${TARGET}maxCpu4.svg";
set title "${TITLE}, ${R4}, smoothed 0.05s, max CPU [%]" offset 0,-1 noenhanced
plot '${PREFIX}maxCpu4_0.05' with filledcurves x1 fs solid 0.1 notitle , '' with lines lt 1 lw 2 notitle;
...
set output "${TARGET}ifUp3.svg";
set title "${TITLE}, ${R3}, smoothed 0.05s, ifUp [b/s]" offset 0,-1 noenhanced
plot '${PREFIX}ifUp3_0.05' with filledcurves x1 fs solid 0.1 notitle , '' with lines lt 1 lw 2 notitle;

set output "${TARGET}ifUp4.svg";
set title "${TITLE}, ${R4}, smoothed 0.05s, ifUp [b/s]" offset 0,-1 noenhanced
plot '${PREFIX}ifUp4_0.05' with filledcurves x1 fs solid 0.1 notitle , '' with lines lt 1 lw 2 notitle;
