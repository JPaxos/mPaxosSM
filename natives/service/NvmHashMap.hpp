...
private:    
    ...
    bool insertOrReplaceIntoInternalArray(pmem::obj::pool_base & pop, const KK & key, const VV & value, ArrayOfSegments& aos) {
...
public:
    ...
    bool insertOrReplace(pmem::obj::pool_base & pop, const KK & key, const VV & value) {
        ...
        bool res = insertOrReplaceIntoInternalArray(pop, key, value, _arrayOfSegments[index]);
    ...
    VV get(KK key) {
        ...
        while (true) {
            if (Comparator()(ptr->key.get_rw(), key)) {
